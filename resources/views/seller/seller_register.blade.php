...
<html lang="en">
    <head>
        ...
        <!-- metis menu -->
        <link rel="stylesheet" href="{{asset('panel/assets/plugins/metismenu/assets/css/metisMenu.min.css')}}">
        <link rel="stylesheet" href="{{asset('panel/assets/plugins/metismenu/assets/css/mm-vertical-hover.css')}}">
        <!-- chart -->
    ...
    <body id="page-top">
        ...
        {{-- <div class="preloader">
            ...
            <div class="content_wrapper">
                ...
                <div class="registration_page center_container">
                    <div class="center_content">
                        ...
                        <form action=" {{ route('seller.register.create')}}" method="get">
                            @csrf
         ...
         <input  type="email" class="form-control" name="email" placeholder="Email Address">
                            ...
                            <div class="form-group">
                                <a class="registration" href=" {{route('seller_login_from')}} ">Already have an account</a><br>
        ...
        <!-- metis menu -->
        <script src="{{asset('panel/assets/plugins/metismenu/assets/js/metismenu.js')}}"></script>
        <script src="{{asset('panel/assets/plugins/metismenu/assets/js/mm-vertical-hover.js')}}"></script>
        <!-- nice scroll bar -->
