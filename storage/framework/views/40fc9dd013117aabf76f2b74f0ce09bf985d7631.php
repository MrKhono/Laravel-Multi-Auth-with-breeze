...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="content_wrapper">
                    ...
                    <div class="login_page center_container">
                        <div class="center_content">
                            ...
                            <form action=" <?php echo e(route('admin.login')); ?>" class="d-block" method="post">
                                <?php echo csrf_field(); ?>
       ...
       <input   type="password" class="form-control"  name="password" required autocomplete="current-password" placeholder="Password">
                                ...
                                <div class="form-group">
                                    <a class="registration" href=" <?php echo e(route('admin.register')); ?> ">Create new account</a><br>
...
</html><?php /**PATH /Users/mac/Desktop/example-app/resources/views/admin/admin_login.blade.php ENDPATH**/ ?>