        ...
        <li><a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a href=" <?php echo e(route ('admin.logout')); ?>"><span><i class="fas fa-unlock-alt"></i></span> Logout</a></li>
                </ul>
            </div>
        </li>
        <li>
...
<h4>Login Admin Name :  <?php echo e(Auth::guard('admin')->user()->name); ?></h4>
<h4>Login Admin Email :  <?php echo e(Auth::guard('admin')->user()->email); ?></h4>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Desktop/example-app/resources/views/admin/index.blade.php ENDPATH**/ ?>