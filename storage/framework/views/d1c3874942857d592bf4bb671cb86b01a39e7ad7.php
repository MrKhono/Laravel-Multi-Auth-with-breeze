...
<img src="<?php echo e(asset('panel/assets/images/logo.png')); ?>" alt="" class="img-fluid logo1">
<img src="<?php echo e(asset('panel/assets/images/logo_small.png')); ?>" alt="" class="img-fluid logo2">
        </a>
    </div>
        ...
        <li><a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a href=" <?php echo e(route ('seller.logout')); ?>"><span><i class="fas fa-unlock-alt"></i></span> Logout</a></li>
                </ul>
            </div>
        </li>
        <li>
...
<h4>Login Seller Name : <?php echo e(Auth::guard('seller')->user()->name); ?>  </h4>
<h4>Login Seller Email : <?php echo e(Auth::guard('seller')->user()->email); ?></h4>
...
<?php echo $__env->make('seller.seller_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/Desktop/example-app/resources/views/seller/index.blade.php ENDPATH**/ ?>