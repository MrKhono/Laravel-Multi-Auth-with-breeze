...
<html lang="en">
    ...
    <body id="page-top">
        <!-- preloader -->
        <div class="preloader">
            <img src="<?php echo e(asset('panel/assets/images/preloader.gif')); ?>" alt="">
        </div>
        <!-- wrapper -->
        <div class="wrapper">
...
</html><?php /**PATH /Users/mac/Desktop/example-app/resources/views/seller/seller_master.blade.php ENDPATH**/ ?>