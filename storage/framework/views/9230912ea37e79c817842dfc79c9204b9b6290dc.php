        ...
        <!-- preloader -->
            ...
            <div class="content_wrapper">
                ...
                <div class="registration_page center_container">
                    <div class="center_content">
                        ...
                        <form action=" <?php echo e(route('seller.register.create')); ?>" method="get">
                            <?php echo csrf_field(); ?>
         ...
         <input  type="email" class="form-control" name="email" placeholder="Email Address">
                            ...
                            <div class="form-group">
                                <a class="registration" href=" <?php echo e(route('seller_login_from')); ?> ">Already have an account</a><br>
...
</html><?php /**PATH /Users/mac/Desktop/example-app/resources/views/seller/seller_register.blade.php ENDPATH**/ ?>